  ...
  return (
    <div className="rounded-lg overflow-hidden" >
      ...
      <div className="p-4 space-y-2">
        ...
        <div className="h-3 rounded animate-pulse" style={{ backgroundColor: 'var(--color-gold-pale)', width: '40%' }} />
        <div className="h-4 rounded animate-pulse" style={{ backgroundColor: 'var(--color-gold-pale)', width: '30%' }} />
      </div>
    </div>
  );
}
