      ...
      >
        <div className="p-5 flex flex-col h-full">
          ...
          <div className="flex items-center gap-3 mb-8 pb-5" style={{ borderBottom: '1px solid rgba(212,175,55,0.2)' }}>
            ...
            <div>
              <p className="text-white font-bold text-sm" style={{ fontFamily: "'Poppins', sans-serif" }}>Admin Panel</p>
              <p className="text-white/40 text-[10px]" style={{ fontFamily: "'Poppins', sans-serif" }}>Aura Living</p>
            </div>
          </div>
          ...
          <nav className="flex-1 flex flex-col gap-1">
            {navItems.map((item) => (
              <button
                ...
                style={{ fontFamily: "'Poppins', sans-serif", fontSize: '14px', fontWeight: activeTab === item.id ? 600 : 400 }}
              >
                  ...
                  return (
                    <div key={data.month} className="flex-1 flex flex-col items-center gap-2">
                      <div className="w-full flex flex-col justify-end" style={{ height: '100%' }}>
                        ...
                        >
                          <div className="absolute -top-8 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap text-[10px] font-bold px-2 py-1 rounded bg-charcoal text-white" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  ...
                  {mockOrders.slice(0, 5).map((order) => {
                    ...
                    return (
                      <div key={order.id} className="flex items-center justify-between gap-3 py-2" style={{ borderBottom: '1px solid rgba(232,213,163,0.4)' }}>
                        ...
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-bold" style={{ backgroundColor: cfg.bg, color: cfg.color, fontFamily: "'Poppins', sans-serif" }}>
