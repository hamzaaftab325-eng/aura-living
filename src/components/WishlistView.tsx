                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        ...
                        className="absolute top-3 right-3 w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 cursor-pointer animate-heartbeat"
                    ...
                    <div className="p-4 sm:p-5">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="w-10 h-10 rounded-sm flex items-center justify-center transition-all duration-200 hover:bg-red-50 cursor-pointer"
